    ...
    <div class="container-fluid" style="background: #3e1149;">
        <div class="row">
            <div class="col-md-6 section-login-1">
                ...
                <div class="logo">
                    <img class="logo-iniciar" src="../assets/img/logo-iniciar.png" alt="LOGO INICIAR">
                        ...
                        <div class="col-md-12 formulario-imput">
                            <div class="imput-text">
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control form-login" id="email"
                                        aria-describedby="email" placeholder="usuario@">
                                </div>
                                <br>
                                <div class="col-md-4">
                                    <label for="password" class="form-label">Contraseña</label>
                                    <div class="iconCheck">
                                        <a v-on:click="mostrarPassword	" href="#pass"><i
                                        class='iconMostrar bx bx-show'></i></a>
                                    </div>
                                    ...
                                    <div>
                                        <button class="btn btn-acceder">Acceder</button>
                                    </div>
                                </div>
                                <div class="register">
                                ...
                                <div class="q-register-div">
                                    ...
                                    <p class="q-register">Quieres registrarte? <span>
